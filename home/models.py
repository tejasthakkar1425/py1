...
class DocDetail(models.Model):
    ...
    vehc_rout = models.ForeignKey('VehicleRoutMaster', models.DO_NOTHING)
    doc_weight = models.DecimalField(max_digits=10, decimal_places=0, blank=True, null=True)
    veh_rout_det = models.ForeignKey('VehRoutDetalis', models.DO_NOTHING)
...
class DocMaster(models.Model):
    ...
    gst_charges = models.ForeignKey('Gstcharges', models.DO_NOTHING)
...
class DocVehDetailsTable(models.Model):
    ...
    doc = models.ForeignKey(DocMaster, models.DO_NOTHING)
    veh = models.ForeignKey('VehicleMaster', models.DO_NOTHING)
    vehc_rout = models.ForeignKey('VehicleRoutMaster', models.DO_NOTHING)
...
class VehRoutDetalis(models.Model):
    ...
    veh_rout = models.ForeignKey('VehicleRoutMaster', models.DO_NOTHING)
    state = models.ForeignKey(StateMasterTable, models.DO_NOTHING)
    ditrict = models.ForeignKey(DistrictMaster, models.DO_NOTHING)
    city_village = models.ForeignKey(CityVillageMaster, models.DO_NOTHING)
