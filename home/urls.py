...
urlpatterns = [
    ...
    path('myordersview',views.myordersview),
    path('myorderssave',views.myorderssave),
    path('empcomplain',views.empcomplain),
    path('empdocview',views.empdocview),
    path('empcomplainedit/<int:id>',views.empcomplainedit),
